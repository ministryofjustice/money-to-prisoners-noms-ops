...
class NotificationListView(TemplateView):
    ...
    def populate_notifications(self, session, context):
        ...
        context['monitored_credits'] = self.get_credit_list(
            session,
            self.request.GET.get('monitored_credits_page', 1),
            monitored=True,
        ...
        context['monitored_disbursements'] = self.get_disbursement_list(
            session,
            self.request.GET.get('monitored_disbursements_page', 1),
            monitored=True,
        ...
        context['not_whole_credits'] = self.get_event_list(
            session,
            self.request.GET.get('not_whole_credits_page', 1),
            rule='NWN',
            for_credit=True,
        ...
        context['not_whole_disbursements'] = self.get_event_list(
            session,
            self.request.GET.get('not_whole_disbursements_page', 1),
            rule='NWN',
        ...
        context['high_amount_credits'] = self.get_event_list(
            session,
            self.request.GET.get('high_amount_credits_page', 1),
            rule='HA',
            for_credit=True,
            triggered_at__gte=start_date,
            triggered_at__lt=end_date,
        ...
        context['high_amount_disbursements'] = self.get_event_list(
            session,
            self.request.GET.get('high_amount_disbursements_page', 1),
            rule='HA',
            for_disbursement=True,
            triggered_at__gte=start_date,
            triggered_at__lt=end_date,
        ...
        context['frequent_senders'] = self.get_event_list(
            session,
            self.request.GET.get('frequent_senders_page', 1),
            rule='CSFREQ',
        ...
        context['frequent_recipients'] = self.get_event_list(
            session,
            self.request.GET.get('frequent_recipients_page', 1),
            rule='DRFREQ',
        ...
        context['from_many_senders'] = self.get_event_list(
            session,
            self.request.GET.get('from_many_senders_page', 1),
            rule='CSNUM',
        ...
        context['to_many_recipients'] = self.get_event_list(
            session,
            self.request.GET.get('to_many_recipients_page', 1),
            rule='DRNUM',
            group_by='prisoner_profile',
            triggered_at__gte=start_date,
            triggered_at__lt=end_date,
        ...
        context['to_many_prisoners'] = self.get_event_list(
            session,
            self.request.GET.get('to_many_prisoners_page', 1),
            rule='CPNUM',
            group_by='sender_profile',
            triggered_at__gte=start_date,
            triggered_at__lt=end_date,
        ...
        context['from_many_prisoners'] = self.get_event_list(
            session,
            self.request.GET.get('from_many_prisoners_page', 1),
            rule='DPNUM',
            group_by='recipient_profile',
            triggered_at__gte=start_date,
            triggered_at__lt=end_date,
    ...
    def get_event_list(self, session, page, **filters):
        event_list = self.get_object_list(
            '/events', session, page, ordering='-triggered_at', **filters
        )
    ...
    def get_credit_list(self, session, page, **filters):
        return self.get_object_list('/credits', session, page, **filters)

    def get_disbursement_list(self, session, page, **filters):
        return self.get_object_list('/disbursements', session, page, **filters)

    def get_object_list(self, path, session, page, **filters):
