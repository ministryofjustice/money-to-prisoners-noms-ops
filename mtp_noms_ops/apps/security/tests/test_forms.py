...
class SenderSecurityFormTestCase(SecurityFormTestCase):
...
class PrisonerSecurityFormTestCase(SecurityFormTestCase):
...
class CreditsSecurityFormTestCase(SecurityFormTestCase):
