...
class UtilTestCase(unittest.TestCase):
    ...
    def test_page_range(self):
        ...
        self.assertSequenceEqual(make_page_range(1, 7), [1, 2, None, 6, 7])
        self.assertSequenceEqual(make_page_range(4, 7), [1, 2, 3, 4, 5, 6, 7])
        self.assertSequenceEqual(make_page_range(5, 7), [1, 2, None, 4, 5, 6, 7])
        self.assertSequenceEqual(make_page_range(7, 7), [1, 2, None, 6, 7])
        self.assertSequenceEqual(make_page_range(7, 10), [1, 2, None, 6, 7, 8, 9, 10])
        self.assertSequenceEqual(make_page_range(7, 100), [1, 2, None, 6, 7, 8, None, 99, 100])
